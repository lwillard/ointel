...
export function Inspector(props: Props) {
  ...
  const changed = idea.history.at(-1)?.cardType !== idea.cardType || idea.history.at(-1)?.body !== idea.body || idea.history.at(-1)?.title !== idea.title || JSON.stringify(idea.history.at(-1)?.tags) !== JSON.stringify(idea.tags);
